...
class Student:
    def __init__(self,root):
        ...
        self.var_teacher=StringVar()
         ...
         #first image
        img=Image.open(r"C:\Users\saite\Desktop\Face Recognition Student Attendence System\College_Images\Student1.jpg")
        ...
        #second image
        img1=Image.open(r"C:\Users\saite\Desktop\Face Recognition Student Attendence System\College_Images\Student3.jpg")
        ...
        #third image
        img2=Image.open(r"C:\Users\saite\Desktop\Face Recognition Student Attendence System\College_Images\Student2.jpg")
        ...
        #background Image
        img3=Image.open(r"C:\Users\saite\Desktop\Face Recognition Student Attendence System\College_Images\face2.jpg")
        ...
        img_left=Image.open(r"C:\Users\saite\Desktop\Face Recognition Student Attendence System\College_Images\Student4.jpg")
        ...
        year_combo["values"]=("Select Year","2020-21","2021-23","2022-23","2023-24")
        ...
        sem_combo["values"]=("Select Year","Semester-1","Semester-2")
        sem_combo.current(0)
        ...
        btn_frame.place(x=5,y=200,width=735,height=35)
        ...
        reset_btn=Button(btn_frame,text="Reset",width=19,command=self.reset_data,font=("times new roman",13,"bold"),bg="blue",fg="white")
        reset_btn.grid(row=0,column=3)


        btn_frame1=Frame(class_student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=5,y=235,width=735,height=35)

        take_photo_btn=Button(btn_frame1,command=self.genrate_dataset,text="Take  Photo ",width=35,font=("times new roman",13,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=1,column=0)

        update_photo_btn=Button(btn_frame1,text="Update  Photo",width=37,command=self.update_data,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\saite\Desktop\Face Recognition Student Attendence System\College_Images\Student6.jpg")
        ...
        search_system_frame.place(x=5,y=135,width=705,height=70)
        ...
        search_entry=ttk.Entry(search_system_frame,width=14,font=("times new roman",12,"bold"))
        search_entry.grid(row=0,column=2,padx=10,pady=5,sticky=W)

        search_btn=Button(search_system_frame,text="Search",width=12,font=("times new roman",11,"bold"),bg="blue",fg="white")
        search_btn.grid(row=0,column=3,padx=4)

        showAll_btn=Button(search_system_frame,text="Show All",width=12,font=("times new roman",11,"bold"),bg="blue",fg="white")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="8686635715",database="face_recognizer")
